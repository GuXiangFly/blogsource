...
可以进群交流 base64：NzA5NjQxNjY5  

或者直接 email base64：Z3V4aWFuZzAyQG1laXR1YW4uY29t

JD:
美团优选-Java 开发工程师 /技术专家（销售后台研发组）
岗位职责
1. 负责服务端的技术方案设计、需求把控、核心功能开发，将业务需求拆解细化并实施；
2. 指导并参与产品的架构规划、性能优化、故障排查和解决、安全加固等工作；

3. 驱动团队与产品团队密切合作；
4. 构建团队并培养团队成员，组织技术分享，促进团队成员进步；
5. 你将为海量服务诉求提供技术支撑，提供高可用高性能的 API 服务；
6. 在极度复杂多样化的业务场景中抽丝剥茧，提炼抽象，不断优化重构既有服务架构

岗位基本需求

1. 本科及以上学历，3 年以上互联网研发工作经验；
2. 具有扎实的计算机科学功底，扎实的编程基础和数据结构算法基础，优秀的编程能力和问题解决能力；
3. 熟练使用常用研发工具，包括但不限于依赖管理打包管理工具 Maven 、版本控制工具 Git 
...
1. 热爱互联网和新技术，优秀的快速学习能力，研究过优秀开源软件的源码并有心得者优先；
2. 参与过同类型业务核心系统建设或高并发系统经验优先；
3. 有“代码洁癖”，有极客精神。

岗位亮点

1. 广阔的平台、先进的技术、完善的晋升发展通道；
2. 与一群可爱且坚持梦想的大牛一起共事，技术驱动业务，用技术改变服务体验生态领域。
...
1. 负责美团优选业务后台销售业务的实时、离线数据系统建设的规划、设计及落地，为数据产品团队、业务团队提供高效的实时、离线数据支持；

2. 负责美团优选业务中销售方向实时、离线数据集市研发及实时、离线数据指标开发；
3. 负责实时、离线数据计算和数据服务的性能优化建设，提供稳定的业务实时、离线数据服务；
4. 岗位基本要求
   1. 具备扎实的计算机科学功底、编程基础和数据结构算法基础，良好的工程素养，高效的问题解决能力；
   2. 掌握数据仓库体系架构、数据建模方法、数据治理等知识；对数据价值探索充满热情，较强的业务理解和抽象能力；
   3. 掌握数据库知识，较强的 SQL/ETL 开发能力；
   4. 精通主流大数据和流式数据处理技术，扎实的大数据和分布式系统建设经验，如 Flink 、Storm 、Flume 、Kafka 等流式大数据计算及运维经验；
   5. 掌握 ES/HBase/Druid/Doris 等 OLAP 引擎者一种以上，掌握 Java/Scala/Python 等开发语言；
      具备以下优先
   6. 具有从零到一搭建实时数仓经验者优先；
   7. 具有开阔的技术眼界和前瞻性并且能够在所负责的方向上进行系统的长期规划及演进；
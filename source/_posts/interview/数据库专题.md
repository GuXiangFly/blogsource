...
| 当前session | 一个普通标题 | 一个普通标题 |
| ------ | ------ | ------ |
| 短文本 | 中等文本 | 稍微长一点的文本 |
| 稍微长一点的文本 | 短文本 | 中等文本 |
```
当前session 对加读锁的表进行插入和更新操作 会报错
session2 对加读锁的表进行插入更新操作会阻塞，
```
...
![测试](https://raw.githubusercontent.com/GuXiangFly/imagerepo/master/20191102104516.png)
![测试2](https://blog.guxiangfly.cn/20191102105344.png)

![](https://blog.guxiangfly.cn/GuXiangFly/imagerepo/20191102105723.png)

![](https://raw.githubusercontent.com/GuXiangFly/imagerepo/master/20191102105840.png)

![xx](guxiangflymd.s3-cn-east-1.qiniucs.com/20191102114151.png)

![XXXXX](https://i.loli.net/2019/11/02/oZzpQ8G2eilsyMh.png)